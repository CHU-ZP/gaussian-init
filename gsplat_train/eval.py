...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate a trained or initialized Gaussian model."
    )
...
def main() -> None:
    ...
    model_path = resolve_scene_path(
        scene_root, args.model or scene_cfg.get("output_path", "init/fused_gaussians.pt")
    )
